...
class QuantizeConfig():
    ...
    def __post_init__(self):
        ...
        if self.dynamic is not None:
            self.dynamic = {
                **{k: v for k, v in self.dynamic.items() if k.startswith('-')},  # First add keys starting with '-'
